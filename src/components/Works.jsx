  ...
  return (
    ...
    >
      <Tilt
        ...
        className="bg-primitive shadow-outer shadow-lg shadow-[#9d4edd] border-purple-400 border-[1px] sm:h-[530px] h-fit rounded-xl p-3 sm:w-[360px] w-full"
      >
        <div className="relative w-full h-[46%]">
          <img
            src={image}
        ...
        <div className="mt-5">
          <h3 className="text-purple-400 font-bold text-[24px]">
            {name}
          </h3>
    ...
    <div>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]"
        >
          Following projects showcase my skills, learning journey, and technical proficiency
          through implementation in real-world projects. A short description of each project
          and links to the GitHub repository are provided for further exploration.
        </motion.p>
      </div>
